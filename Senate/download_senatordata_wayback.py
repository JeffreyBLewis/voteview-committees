#!/usr/bin/env python3
"""
Download every archived version of https://www.senate.gov/general/contact_information/senators_cfm.xml
from the Wayback Machine using waybackpy.

Usage:
    pip install waybackpy requests
    python3 download_senatordata_wayback.py
"""
...
OUTPUT_DIR = Path("SenatorData_snapshots")
...
def main():
    parser = argparse.ArgumentParser(description="Download all Wayback snapshots of senators_cfm.xml")
    ...
    for i, snap in enumerate(snapshots, 1):
        ...
        dest = out_dir / f"SenatorData_{timestamp}.xml"
